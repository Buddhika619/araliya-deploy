    ...
    <>
      <Router>
        <Routes>
          ...
          <Route
            path="/reports/annualcost"
            element={<AnnualExpencesReport />}
          />
          <Route
            path="/reports/monthlycost"
            element={<MonthlyExpencesReport />}
          />
          <Route
            path="/reports/annualprofit"
            element={<AnnualProfitReport />}
          />
          <Route
            path="/reports/monthlyprofit"
            element={<MonthlyProfitReport />}
          />
          <Route
            path="/reports/salesafter/:date"
            element={<SalesAfterReport />}
          />
          <Route
            path="/reports/costafter/:date"
            element={<CostAfterReport />}
          />
          <Route
            path="/reports/profitafter/:date"
            element={<ProfitAfterReport />}
          />
        </Routes>
      </Router>
      <ToastContainer />
