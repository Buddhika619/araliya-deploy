...
const ProudctOutStockListScreen = () => {
  ...
  const productList = useSelector((state) => state.stockProuct);
...
console.log(products)
    rows = products.products?.map((row) => ({
      ...
      REVIEWNUMBER: row.product.numReviews,
...
export default ProudctOutStockListScreen;
